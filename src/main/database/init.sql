...
-- Inserts para need
INSERT INTO needs (id_need, description, publish_date, enabled, id_event) VALUES
(1,  'Se necesitan médicos para la maratón', '2024-03-20 10:00:00', TRUE, 1),
(2, 'Se necesitan enfermeros para el concierto', '2024-03-21 10:00:00', TRUE, 1),
(3,  'Se necesitan psicólogos para el taller', '2024-03-22 10:00:00', TRUE, 3);
