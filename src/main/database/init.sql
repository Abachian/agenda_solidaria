...
CREATE TABLE IF NOT EXISTS event_types (
  id_event_type BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS organization_types (
  id_organization_type BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
  description VARCHAR NOT NULL
);
...
CREATE TABLE IF NOT EXISTS professions (
  id_profession BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
  description VARCHAR NOT NULL
);
...
CREATE TABLE IF NOT EXISTS organizations (
  id_organization BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS volunteers (
  id_volunteer BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS events (
  id_event BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS images (
  id_image BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS needs (
  id_need BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
  description TEXT NOT NULL,
  publish_date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  enabled BOOLEAN NOT NULL DEFAULT TRUE,
...
CREATE TABLE IF NOT EXISTS resources (
  id_resource BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
  description VARCHAR(255) NOT NULL,
  quantity INTEGER NOT NULL DEFAULT 0,
  id_event INTEGER NOT NULL,
  CONSTRAINT fk_resource_event FOREIGN KEY (id_event) REFERENCES events (id_event)
);
...
CREATE TABLE IF NOT EXISTS volunteer_profession (
  id_volunteer_profession BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS postulates (
  id_postulate BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS phone_numbers (
   id_phone BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
...
INSERT INTO volunteers (
    ...
    location
      ...
      (1, '12345678', 'DNI', 54, 4.5, 30, 'Tandil'),
      (2, '87654321', 'DNI', 55, 4.0, 40, 'Tandil'),
      (3, '45678912', 'DNI', 56, 4.2, 35, 'Tandil'),
      (4, '78912345', 'DNI', 58, 4.3, 45, 'Tandil'),
      (5, '32165498', 'DNI', 60, 4.0, 30, 'Tandil');
...
-- Inserts para need
INSERT INTO needs (id_need, description, publish_date, enabled, required_volunteers, id_event) VALUES
(1,  'Se necesitan médicos para la maratón', '2024-03-20 10:00:00', TRUE, 100, 1),
(2, 'Se necesitan enfermeros para el concierto', '2024-03-21 10:00:00', TRUE, 50, 1),
(3,  'Se necesitan psicólogos para el taller', '2024-03-22 10:00:00', TRUE, 20, 3);

-- Inserts para resources
INSERT INTO resources (id_resource, description, quantity, id_event) VALUES
(1, 'Medicamentos para la maratón', 100, 1),
(2, 'Equipo de sonido para el concierto', 1, 2),
(3, 'Materiales para el taller de nutrición', 50, 3);

-- Inserts para volunteer_profession
INSERT INTO volunteer_profession (id_volunteer_profession, id_volunteer, id_profession) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 2, 3),
(4, 2, 4),
...
INSERT INTO postulates (id_postulate, acepted, id_volunteer, id_need, postulated_date) VALUES
(1, TRUE, 1, 1, '2024-03-20 10:00:00'),
(2, FALSE, 2, 2, '2024-03-21 10:00:00'),
(3, TRUE, 3, 3, '2024-03-22 10:00:00'),
(4, FALSE, 4, 1, '2024-03-23 10:00:00'),
(5, TRUE, 5, 2, '2024-03-24 10:00:00');
