...
public class OrganizationTypeController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<OrganizationType> getOrganizationTypeById(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<OrganizationType> updateOrganizationType(@PathVariable Long id, @RequestBody OrganizationType organizationType) {
        try {
